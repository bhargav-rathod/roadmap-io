    ...
    try {
      ...
      ${roadmapData.role} at ${roadmapData.company},`;
        ...
        if (roadmapData.roleType === 'IT') {
            prompt += `\n5. DSA & System Design Questions - Include at least **150+ Data Structures and Algorithms (DSA)** and **System Design** questions with clear and appropriate answers.`;
        ...
        prompt += `\nMake sure the roadmap is clear, long, structured, and practically applicable. Include bullet points, sections, and formatting where necessary.`;
